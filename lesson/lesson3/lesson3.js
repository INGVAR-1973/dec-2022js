...
for (let i = 0; i < 10; i++) {
    console.log(i);
    document.write(`<div>long text ${i}</div>`);
...
let j = 0;
while (j < 20) {
    document.write(`<div>Smart </div>`);
    j++
}
// // - За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом і індексом всередині.
let s = 0;
while (s < 20) {
    document.write(`<div>Lux-- ${s} </div>`);
    s++
}
//
...
document.write(`<ul>`);
for (const lisOfItem of lisOfItems) {
    document.write(`<li>${lisOfItem}</li>`);
}
document.write(`</ul>`);
// //
// // ШАБЛОН:
